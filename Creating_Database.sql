DROP DATABASE IF EXISTS `Covid_19_cases`; 
CREATE DATABASE `Covid_19_cases`; 
USE `Covid_19_cases`;
...
CREATE TABLE `country` (
  ...
  `recovered` int,
  `new cases` int,
  `WHO region` varchar(50),
  PRIMARY KEY (`country_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
INSERT INTO `country` VALUES (1,'Afghanistan',36263, 1269,25198,9796,'Eastern Mediterranean');
INSERT INTO `country` VALUES (2,'Albania',4880, 144,2745,1991,'Europe');
INSERT INTO `country` VALUES (3,'Algeria',27973, 1163,18837,7973,'Africa');
INSERT INTO `country` VALUES (4,'Antigua and Barbuda',86, 3,65,18,'America');
INSERT INTO `country` VALUES (5,'Australia',15303,167,9311,5825,'Western Pacific');
INSERT INTO `country` VALUES (6,'Bahrain',39482,141,36110,3231,'Eastern Mediterranean');
INSERT INTO `country` VALUES (7,'Bangladish',226225,2965
,125683,97577,'South-East Asia');


CREATE TABLE `full grouped` (
...
INSERT INTO `full grouped` VALUES (1,'Afghanistan','1/22/2020',33.93911, 67.70995,'E_Meditranian');
INSERT INTO `full grouped` VALUES (2,'Albania','1/22/2020', 41.1533,20.1683,'Europe');
INSERT INTO `full grouped` VALUES (3,'Algeria','1/22/2020', 28.0339, 1.6596,'Africa');
INSERT INTO `full grouped` VALUES (4,'Antigua and Barbuda','1/22/2020',17.0608,-61.7964,'America');
INSERT INTO `full grouped` VALUES (5,'Australia','1/22/2020',-33.8688,151.2093,'Western Pacific');
INSERT INTO `full grouped` VALUES (6,'Bahrain','1/22/2020',26.0275,50.55,'Eastern Mediterranean');
INSERT INTO `full grouped` VALUES (7,'Bangladish','1/22/2020',23.685,90.3563,'South-East Asia');
CREATE TABLE `usa_cases` (
  ...
  `Lat` int(11) NOT NULL,
  `Long_` int(11) NOT NULL,
  `date_` char(20) NOT NULL,
  `Confirmed` int(11) NOT NULL,
  `death` int(11) NOT NULL,
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
INSERT INTO `usa_cases` VALUES (16,'AS','ASM', 16, 60,'American','us',-14.271,-170.132,'1/22/2020',0,0);
INSERT INTO `usa_cases` VALUES (316,'GU','GUM',316,	66,'Guam','US', 13.4443, 144.7937,'1/22/2020',0,0);
INSERT INTO `usa_cases` VALUES (580,'MP','MNP',580,	69,	'Northern Mariana','US',15.0979,145.6739,'1/22/2020',0,0);
INSERT INTO `usa_cases` VALUES (63072001,'PRI','PRI',630, 72001, 'Adjuntas','US',18.180117,-66.754367,'1/22/2020',0,0);
INSERT INTO `usa_cases` VALUES (63072006,'PR','PRI',30,72007,'Aguas Buenas','US','18.251619',-66.126806,'1/22/2020',0,	0);
INSERT INTO `usa_cases` VALUES (63072007,'PR','PRI',630,72007,'Aguas Buenas','US', 18.251619,-66.126806,'1/22/2020',0,0);
INSERT INTO `usa_cases` VALUES (63072009,'PR','PRI',630,72009,'Aibonito','US',18.131361,-66.264131, '1/22/2020',0,0);
INSERT INTO `usa_cases` VALUES (63072011,'PR','PRI',630,72011,'Anasco','US',18.287985,	-67.120611,	'1/22/2020',0,0);
INSERT INTO `usa_cases` VALUES (63072013,'PR','PRI',630	,72013,	'Arecibo','US',18.406631,-66.675077,'1/22/2020',0,0);
